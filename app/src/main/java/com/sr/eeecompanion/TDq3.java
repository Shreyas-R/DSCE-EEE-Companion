 ...
 */
public class TDq3 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.tdq3, R.string.tdq3);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(TDq3.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_tdjune20121(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_tdjune20122(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_tddec20121(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_tddec20122(), "DEC-P2");
