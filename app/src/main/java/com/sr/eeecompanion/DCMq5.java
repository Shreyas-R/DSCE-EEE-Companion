 ...
 */
public class DCMq5 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.dcmq5, R.string.dcmq5);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(DCMq5.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_dcmjune20141(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_dcmjune20142(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_dcmdec20141(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_dcmdec20142(), "DEC-P2");
