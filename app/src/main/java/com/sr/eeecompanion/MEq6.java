...
public class MEq6 extends MEq {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.meq6, R.string.meq6);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(MEq6.this, new GestureDetector.SimpleOnGestureListener() {
