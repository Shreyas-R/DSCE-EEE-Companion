 ...
 */
public class LICAq extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.questionbank_lica_name, R.string.questionbank_lica_name);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(LICAq.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.button_2010) {
            Intent intent = new Intent(LICAq.this, LICAq1.class);
            startActivity(intent);

        } else if (v.getId() == R.id.button_2011) {
            Intent intent = new Intent(LICAq.this, LICAq2.class);
            startActivity(intent);
        } else if (v.getId() == R.id.button_2012) {
            Intent intent = new Intent(LICAq.this, LICAq3.class);
            startActivity(intent);
        } else if (v.getId() == R.id.button_2013) {
            Intent intent = new Intent(LICAq.this, LICAq4.class);
            startActivity(intent);
        } else if (v.getId() == R.id.button_2014) {
            Intent intent = new Intent(LICAq.this, LICAq5.class);
            startActivity(intent);
        } else if (v.getId() == R.id.button_2015) {
            Intent intent = new Intent(LICAq.this, LICAq6.class);
            startActivity(intent);
        }
