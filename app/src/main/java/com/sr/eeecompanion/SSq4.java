 ...
 */
public class SSq4 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.ssq4, R.string.ssq4);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(SSq4.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_ssjune20131(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_ssjune20132(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_ssdec20131(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_ssdec20132(), "DEC-P2");
