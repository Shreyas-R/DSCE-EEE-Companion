 ...
 */
public class LICAq5 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.licaq5, R.string.licaq5);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(LICAq5.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_licajune20141(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_licajune20142(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_licadec20141(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_licadec20142(), "DEC-P2");
