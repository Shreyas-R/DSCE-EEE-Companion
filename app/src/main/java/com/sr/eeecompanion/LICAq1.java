 ...
 */
public class LICAq1 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.licaq1, R.string.licaq1);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(LICAq1.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_licajune20101(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_licajune20102(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_licadec20101(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_licadec20102(), "DEC-P2");
