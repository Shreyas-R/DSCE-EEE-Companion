 ...
 */
public class syllabus_sem3 extends AppCompatActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final GestureDetector mGestureDetector = new GestureDetector(syllabus_sem3.this, new GestureDetector.SimpleOnGestureListener() {
