...
public class SSq extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.questionbank_ss_name, R.string.questionbank_ss_name);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(SSq.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.button_2010) {
            Intent intent = new Intent(SSq.this, SSq1.class);
            startActivity(intent);

        } else if (v.getId() == R.id.button_2011) {
            Intent intent = new Intent(SSq.this, SSq2.class);
            startActivity(intent);
        } else if (v.getId() == R.id.button_2012) {
            Intent intent = new Intent(SSq.this, SSq3.class);
            startActivity(intent);
        } else if (v.getId() == R.id.button_2013) {
            Intent intent = new Intent(SSq.this, SSq4.class);
            startActivity(intent);
        } else if (v.getId() == R.id.button_2014) {
            Intent intent = new Intent(SSq.this, SSq5.class);
            startActivity(intent);
        } else if (v.getId() == R.id.button_2015) {
            Intent intent = new Intent(SSq.this, SSq6.class);
            startActivity(intent);
        }
