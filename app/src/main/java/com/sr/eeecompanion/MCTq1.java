 ...
 */
public class MCTq1 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.mctq1, R.string.mctq1);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(MCTq1.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_mctjune20101(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_mctjune20102(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_mctdec20101(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_mctdec20102(), "DEC-P2");
