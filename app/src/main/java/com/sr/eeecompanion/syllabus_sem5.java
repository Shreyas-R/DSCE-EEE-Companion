 ...
 */
public class syllabus_sem5 extends AppCompatActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final GestureDetector mGestureDetector = new GestureDetector(syllabus_sem5.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_syllabus_me(), "ME");
        adapter.addFragment(new fragment_syllabus_ss(), "SS");
        adapter.addFragment(new fragment_syllabus_td(), "TD");
        adapter.addFragment(new fragment_syllabus_dcm(), "DCM");
        adapter.addFragment(new fragment_syllabus_mct(), "MCT");
        adapter.addFragment(new fragment_syllabus_lica(), "LICA");
        adapter.addFragment(new fragment_syllabus_csml(), "CSML");
        adapter.addFragment(new fragment_syllabus_timl(), "TIML");
