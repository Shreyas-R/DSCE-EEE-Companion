...
public class sem6 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.sem6, R.string.sem6);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(sem6.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.button_sem_choice1) {
            ...
            Intent intent = new Intent(sem6.this, syllabus_sem6.class);
