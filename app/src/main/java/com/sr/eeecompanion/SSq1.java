 ...
 */
public class SSq1 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.ssq1, R.string.ssq1);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(SSq1.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_ssjune20101(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_ssjune20102(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_ssdec20101(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_ssdec20102(), "DEC-P2");
