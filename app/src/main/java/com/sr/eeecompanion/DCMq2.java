 ...
 */
public class DCMq2 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.dcmq2, R.string.dcmq2);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(DCMq2.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_dcmjune20111(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_dcmjune20112(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_dcmdec20111(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_dcmdec20112(), "DEC-P2");
