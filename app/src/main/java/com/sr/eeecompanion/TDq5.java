 ...
 */
public class TDq5 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.tdq5, R.string.tdq5);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(TDq5.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_tdjune20141(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_tdjune20142(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_tddec20141(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_tddec20142(), "DEC-P2");
