 ...
 */
public class MCTq2 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.mctq2, R.string.mctq2);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(MCTq2.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_mctjune20111(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_mctjune20112(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_mctdec20111(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_mctdec20112(), "DEC-P2");
