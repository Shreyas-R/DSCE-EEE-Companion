...
public class MEq3 extends MEq {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.meq3, R.string.meq3);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(MEq3.this, new GestureDetector.SimpleOnGestureListener() {
