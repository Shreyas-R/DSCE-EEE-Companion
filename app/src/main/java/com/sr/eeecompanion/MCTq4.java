 ...
 */
public class MCTq4 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.mctq4, R.string.mctq4);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(MCTq4.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_mctjune20131(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_mctjune20132(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_mctdec20131(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_mctdec20132(), "DEC-P2");
