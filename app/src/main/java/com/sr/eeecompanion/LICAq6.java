 ...
 */
public class LICAq6 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.licaq6, R.string.licaq6);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(LICAq6.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_licajune20151(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_licajune20152(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_licadec20151(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_licadec20152(), "DEC-P2");
