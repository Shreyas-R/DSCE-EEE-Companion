 ...
 */
public class TDq2 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.tdq2, R.string.tdq2);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(TDq2.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_tdjune2011(), "JUNE");
        adapter.addFragment(new fragment_questionbank_tddec20111(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_tddec20112(), "DEC-P2");
