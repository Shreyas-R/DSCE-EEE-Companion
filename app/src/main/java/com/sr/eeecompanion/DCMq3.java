 ...
 */
public class DCMq3 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.dcmq3, R.string.dcmq3);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(DCMq3.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_dcmjune20121(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_dcmjune20122(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_dcmdec2012(), "DEC");
