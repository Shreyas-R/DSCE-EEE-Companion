 ...
 */
public class MCTq extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.questionbank_mct_name, R.string.questionbank_mct_name);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(MCTq.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.button_2010) {
            Intent intent = new Intent(MCTq.this, MCTq1.class);
            startActivity(intent);

        } else if (v.getId() == R.id.button_2011) {
            Intent intent = new Intent(MCTq.this, MCTq2.class);
            startActivity(intent);
        } else if (v.getId() == R.id.button_2012) {
            Intent intent = new Intent(MCTq.this, MCTq3.class);
            startActivity(intent);
        } else if (v.getId() == R.id.button_2013) {
            Intent intent = new Intent(MCTq.this, MCTq4.class);
            startActivity(intent);
        } else if (v.getId() == R.id.button_2014) {
            Intent intent = new Intent(MCTq.this, MCTq5.class);
            startActivity(intent);
        } else if (v.getId() == R.id.button_2015) {
            Intent intent = new Intent(MCTq.this, MCTq6.class);
            startActivity(intent);
        }
