...
public class MEq4 extends MEq {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.meq4, R.string.meq4);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(MEq4.this, new GestureDetector.SimpleOnGestureListener() {
