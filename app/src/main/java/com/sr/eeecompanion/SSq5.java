 ...
 */
public class SSq5 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.ssq5, R.string.ssq5);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(SSq5.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_ssjune20141(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_ssjune20142(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_ssdec20141(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_ssdec20142(), "DEC-P2");
