 ...
 */
public class TDq extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.questionbank_td_name, R.string.questionbank_td_name);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(TDq.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.button_2010) {
            Intent intent = new Intent(TDq.this, TDq1.class);
            startActivity(intent);

        } else if (v.getId() == R.id.button_2011) {
            Intent intent = new Intent(TDq.this, TDq2.class);
            startActivity(intent);
        } else if (v.getId() == R.id.button_2012) {
            Intent intent = new Intent(TDq.this, TDq3.class);
            startActivity(intent);
        } else if (v.getId() == R.id.button_2013) {
            Intent intent = new Intent(TDq.this, TDq4.class);
            startActivity(intent);
        } else if (v.getId() == R.id.button_2014) {
            Intent intent = new Intent(TDq.this, TDq5.class);
            startActivity(intent);
        } else if (v.getId() == R.id.button_2015) {
            Intent intent = new Intent(TDq.this, TDq6.class);
            startActivity(intent);
        }
