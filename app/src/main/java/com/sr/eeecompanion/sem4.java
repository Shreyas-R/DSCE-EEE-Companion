...
public class sem4 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.sem4, R.string.sem4);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(sem4.this, new GestureDetector.SimpleOnGestureListener() {
