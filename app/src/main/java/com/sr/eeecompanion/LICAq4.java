 ...
 */
public class LICAq4 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.licaq4, R.string.licaq4);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(LICAq4.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_licajune20131(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_licajune20132(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_licadec20131(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_licadec20132(), "DEC-P2");
