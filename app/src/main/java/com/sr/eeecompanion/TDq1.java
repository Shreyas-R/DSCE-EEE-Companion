 ...
 */
public class TDq1 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.tdq1, R.string.tdq1);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(TDq1.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_tdjune20101(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_tdjune20102(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_tddec20101(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_tddec20102(), "DEC-P2");
