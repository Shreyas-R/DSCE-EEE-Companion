 ...
 */
public class SSq2 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.ssq2, R.string.ssq2);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(SSq2.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_ssjune20111(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_ssjune20112(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_ssdec20111(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_ssdec20112(), "DEC-P2");
