 ...
 */
public class SSq6 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.ssq6, R.string.ssq6);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(SSq6.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_ssjune20151(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_ssjune20152(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_ssdec20151(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_ssdec20152(), "DEC-P2");
