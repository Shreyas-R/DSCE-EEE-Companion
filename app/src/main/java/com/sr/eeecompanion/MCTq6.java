 ...
 */
public class MCTq6 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.mctq6, R.string.mctq6);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(MCTq6.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_mctjune20151(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_mctjune20152(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_mctdec20151(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_mctdec20152(), "DEC-P2");
