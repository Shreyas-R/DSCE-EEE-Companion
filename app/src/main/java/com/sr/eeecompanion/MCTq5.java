 ...
 */
public class MCTq5 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.mctq5, R.string.mctq5);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(MCTq5.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_mctjune20141(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_mctjune20142(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_mctdec20141(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_mctdec20142(), "DEC-P2");
