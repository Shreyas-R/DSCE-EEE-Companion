 ...
 */
public class DCMq4 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.dcmq4, R.string.dcmq4);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(DCMq4.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_dcmjune20131(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_dcmjune20132(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_dcmdec20131(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_dcmdec20132(), "DEC-P2");
