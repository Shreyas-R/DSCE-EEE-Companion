 ...
 */
public class SSq3 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.ssq3, R.string.ssq3);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(SSq3.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_ssjune20121(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_ssjune20122(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_ssdec20121(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_ssdec20122(), "DEC-P2");
