...
public class sem3 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.sem3, R.string.sem3);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(sem3.this, new GestureDetector.SimpleOnGestureListener() {
