 ...
 */
public class LICAq2 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.licaq2, R.string.licaq2);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(LICAq2.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_licajune20111(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_licajune20112(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_licadec20111(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_licadec20112(), "DEC-P2");
