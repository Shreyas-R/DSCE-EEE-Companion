 ...
 */
public class DCMq1 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.dcmq1, R.string.dcmq1);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(DCMq1.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_dcmjune20101(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_dcmjune20102(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_dcmdec20101(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_dcmdec20102(), "DEC-P2");
