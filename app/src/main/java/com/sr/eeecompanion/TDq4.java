 ...
 */
public class TDq4 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.tdq4, R.string.tdq4);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(TDq4.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_tdjune20131(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_tdjune20132(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_tddec20131(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_tddec20132(), "DEC-P2");
