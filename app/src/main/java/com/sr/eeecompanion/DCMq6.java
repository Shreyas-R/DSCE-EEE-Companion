 ...
 */
public class DCMq6 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.dcmq6, R.string.dcmq6);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(DCMq6.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_dcmjune20151(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_dcmjune20152(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_dcmdec20151(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_dcmdec20152(), "DEC-P2");
