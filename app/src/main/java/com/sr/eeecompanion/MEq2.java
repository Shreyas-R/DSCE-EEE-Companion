...
public class MEq2 extends MEq {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.meq2, R.string.meq2);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(MEq2.this, new GestureDetector.SimpleOnGestureListener() {
