...
public class sem5 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.sem5, R.string.sem5);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(sem5.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.button_sem_choice1) {
            ...
            Intent intent = new Intent(sem5.this, syllabus_sem5.class);
            startActivity(intent);
        }
        else if (v.getId() == R.id.button_sem_choice4) {
            Intent intent = new Intent(sem5.this, questionbank_sem5.class);
            startActivity(intent);
        }
        else if (v.getId() == R.id.button_sem_choice5) {
            Intent intent = new Intent(sem5.this, timetable_sem5.class);
            startActivity(intent);
        }
        else if (v.getId() == R.id.button_sem_choice6) {
            Intent intent = new Intent(sem5.this, tests_exams_sem5.class);
            startActivity(intent);
        }
