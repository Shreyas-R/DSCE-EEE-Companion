 ...
 */
public class MCTq3 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.mctq3, R.string.mctq3);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(MCTq3.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new fragment_questionbank_mctjune20121(), "JUNE-P1");
        adapter.addFragment(new fragment_questionbank_mctjune20122(), "JUNE-P2");
        adapter.addFragment(new fragment_questionbank_mctdec20121(), "DEC-P1");
        adapter.addFragment(new fragment_questionbank_mctdec20122(), "DEC-P2");
