...
public class MEq1 extends MEq {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(this, drawerLayout, toolbar, R.string.meq1, R.string.meq1);
        ...
        final GestureDetector mGestureDetector = new GestureDetector(MEq1.this, new GestureDetector.SimpleOnGestureListener() {
